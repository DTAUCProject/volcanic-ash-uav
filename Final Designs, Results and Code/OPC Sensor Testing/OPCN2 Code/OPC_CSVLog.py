########################################################################
# Program to log various particle concentration readings from the OPCN2
# sensor and Raspberry Pi to a computer via a serial link and GoBetwino 
# software. Currently 5 intermediate particle concentrations are logged,
# as well as the total concentration and sample flow rate. Note that this
# is done assuming a certain particle bulk density as defined in the 
# constants.
#
...
########################################################################
# Main function to set up ports then log concentration data
...
def main():
	...
	try:
		while (1):		
			...
			# Now log data in format required for GoBetwino serial logging program:
